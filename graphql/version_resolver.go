...
func (r *versionResolver) BuildVariants(ctx context.Context, obj *restModel.APIVersion, options version.BuildVariantOptions) ([]*GroupedBuildVariant, error) {
	...
	groupedBuildVariants, err := model.GenerateBuildVariants(utility.FromStringPtr(obj.Id), options, utility.FromStringPtr(obj.Requester))
	if err != nil {
...
func (r *versionResolver) BuildVariantStats(ctx context.Context, obj *restModel.APIVersion, options version.BuildVariantOptions) ([]*task.GroupedTaskStatusCount, error) {
