...
func TestSimulateNewDependencyGraph(t *testing.T) {
	...
	t.Run("CreatesCycle", func(t *testing.T) {
		// Generator generates: --> A (depends on) --> B
		//                      --> B (depends on) --> C
		//                      --> C (depends on) --> A
		//   +-----+            +-----+
		//   |  A  |            |  C  |
	...
	t.Run("Dependent on Generator ('loop')", func(t *testing.T) {
	...
	t.Run("Dependent on Generator ('cycle')", func(t *testing.T) {
		...
		// graph it would look like this, because generated can't run before the generator (and inherently "dependent" on the generator)
		//   +-----------+            +-----+
		//   | generator |            |  A  |
		//   +-----------+ <--------- +-----+
		//                  ^        ^
