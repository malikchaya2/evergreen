...
func TestDiscoverAndCacheProjectBucket(t *testing.T) {
	t.Run("NewBucket", func(t *testing.T) {
		...
		discovered := DiscoverAndCacheProjectBucket(t.Context(), "test-bucket", "us-east-1", nil, "test-project", mockClient)
	...
	t.Run("AlreadyCached", func(t *testing.T) {
		...
		discovered := DiscoverAndCacheProjectBucket(t.Context(), "cached-bucket", "us-east-1", nil, "test-project", mockClient)
	...
	t.Run("AWSError", func(t *testing.T) {
		...
		discovered := DiscoverAndCacheProjectBucket(t.Context(), "error-bucket", "us-east-1", nil, "test-project", mockClient)
	...
	t.Run("NoLifecycleRules", func(t *testing.T) {
		...
		discovered := DiscoverAndCacheProjectBucket(t.Context(), "empty-bucket", "us-east-1", nil, "test-project", mockClient)
